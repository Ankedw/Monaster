...
if DevRio:get(Prox.."Rio:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '⌁︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevRio:setex(Prox..'Rio:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
